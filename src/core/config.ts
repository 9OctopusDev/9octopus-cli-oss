...
class Config {
    ...
    private settings = {
        ...
        NETWORK_RETRY_MAX_ATTEMPTS: process.env['NETWORK_RETRY_MAX_ATTEMPTS'] || '3',
        ...
        NETWORK_RETRY_JITTER_PERCENT: process.env['NETWORK_RETRY_JITTER_PERCENT'] || '25',
        NETWORK_CONNECTION_TIMEOUT: process.env['NETWORK_CONNECTION_TIMEOUT'] || '30000',
